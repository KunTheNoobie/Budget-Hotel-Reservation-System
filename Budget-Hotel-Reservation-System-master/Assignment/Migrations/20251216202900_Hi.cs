        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    LimitPerPhoneNumber = table.Column<bool>(type: "bit", nullable: false),
                    LimitPerPaymentCard = table.Column<bool>(type: "bit", nullable: false),
                    LimitPerDevice = table.Column<bool>(type: "bit", nullable: false),
                    LimitPerUserAccount = table.Column<bool>(type: "bit", nullable: false),
                    MaxUsesPerLimit = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageItems_RoomTypes_RoomTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoomTypeAmenityId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoomTypeId = table.Column<int>(type: "int", nullable: false),
                    AmenityId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomTypeAmenities", x => x.RoomTypeAmenityId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromotionIpAddress = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PromotionUsedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageItems_RoomTypeId",
                table: "PackageItems",
                column: "RoomTypeId");
